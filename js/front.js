...
$(window).on("load",function () {
    ...
    videoButton.on('click', function(){
        ...
        videoIframeContainer.append('<iframe src="https://www.youtube.com/embed/nKm4BC_jS04?autoplay=1&rel=0&showinfo=0" allowfullscreen="allowfullscreen" width="100%" height="100%" frameborder="0"></iframe> ');
    });
